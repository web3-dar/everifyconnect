  ...
  <div className="fixed inset-0 bg-black bg-opacity-80 flex justify-center items-center z-50">
    <div className="bg-white rounded-lg p-6 w-[350px] h-[400px] max-w-md text-center shadow-lg flex flex-col justify-center">
      ...
      <div className="w-full max-w-md bg-white p-6 text-center relative">
        ...
        <div className="px-2 py-5 mb-3  bg-blue-100 w-[80%] m-auto">We sent an email to you</div>

        {/* Message */}
        <p className="text-black text-sm mb-6">
         Click your inbox for an email hello@idme and click the link inside to confirm your email address. if you do not receive an email within 10 minutes, check your spam folder and verify it hasn't been blocked
          <br />
